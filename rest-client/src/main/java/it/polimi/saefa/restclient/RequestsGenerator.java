...
public class RequestsGenerator {
    ...
    public void init() {
        ...
        // Stop simulation after 20 minutes
        ...
        stopSimulationTimer.schedule(stopSimulationTask, 1000*60*20);
    }
    ...
    class SimulationRoutine implements Runnable {
        ...
        public void run() {
            ...
            if (restaurants == null || restaurants.size() < 1) throw new RuntimeException("No restaurants available");
            ...
            if (menu == null || menu.getMenuItems().size() < 1) throw new RuntimeException("No menu items available");
            ...
            if (cart == null || cart.getItems().size() != 1) throw new RuntimeException("Wrong number of items in cart");
            ...
            if (returnedItem.getQuantity() != 2 ||
                    ...
                    cart.getTotalPrice() != menuItem.getPrice() * 2) throw new RuntimeException("Inconsistent cart");
