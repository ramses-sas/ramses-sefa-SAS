package it.polimi.sofa.configmanager.aoplog;
...
public class ConfigManagerLoggingAspect {
    ...
    @Pointcut("execution(public * it.polimi.sofa.configmanager.domain.ConfigManagerService.*(..))")
    public void configManagerMethods() {}

    @Pointcut("execution(public void it.polimi.sofa.configmanager.domain.ConfigManagerService.*(..))")
