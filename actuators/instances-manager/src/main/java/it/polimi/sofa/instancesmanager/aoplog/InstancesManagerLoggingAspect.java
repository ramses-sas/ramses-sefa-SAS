package it.polimi.sofa.instancesmanager.aoplog;
...
public class InstancesManagerLoggingAspect {
    ...
    @Pointcut("execution(public * it.polimi.sofa.instancesmanager.domain.InstancesManagerService.*(..))")
    public void instancesManagerMethods() {}

    @Pointcut("execution(public void it.polimi.sofa.instancesmanager.domain.InstancesManagerService.*(..))")
