...
start_time = timedelta(hours = 19, minutes = 31, seconds = 55) # l'istanza 58090 era già accesa
end_time = timedelta(hours = 19, minutes = 41, seconds = 45)
...
start_instance_events = [ # UNA NUOVA ISTANZA PUO' RICEVERE RICHIESTE (E' SU EUREKA)
    ...
    timedelta(hours = 19, minutes = 32, seconds = 47), # l'istanza 58090 è stata riavviata dal simulatore
    timedelta(hours = 19, minutes = 33, seconds = 3), # la nuova istanza è stata avviata dopo che il Managing l'ha accesa
]
stop_instance_events = [ # when the instance deregisters from Eureka
    ...
    timedelta(hours = 19, minutes = 32, seconds = 29), #  l'istanza 58090 è stata spenta dal simulatore (failure injection)
    timedelta(hours = 19, minutes = 32, seconds = 53), #  l'istanza 58090 è stata spenta dal Managing
]
...
add_instance_events = [ # when the instance is again in the list of instances of the service
    timedelta(hours = 19, minutes = 32, seconds = 55) # la nuova istanza viene accesa dall'execute
]
shutdown_instance_events = [ # when the STOP INSTANCE option is applied by the actuator
    timedelta(hours = 19, minutes = 32, seconds = 52)
]
