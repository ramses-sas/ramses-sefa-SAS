package it.polimi.sofa.restclient.aoplog;
...
public class RestClientLoggingAspect {
    ...
    @Pointcut("execution(public * it.polimi.sofa.restclient.domain.RequestGeneratorService.*(..))")
    public void restClientMethods() {}

    @Pointcut("execution(public void it.polimi.sofa.restclient.domain.RequestGeneratorService.*(..))")
