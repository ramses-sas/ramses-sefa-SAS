package it.polimi.saefa.orderingservice.aop;

import it.polimi.saefa.orderingservice.exceptions.ForcedException;
...
public class InstrumentationAspect {
    ...
    @Pointcut("execution(public * it.polimi.saefa.orderingservice.domain.OrderingService.*(..))")
    public void orderingServiceMethods() {}

    @Pointcut("execution(public void it.polimi.saefa.orderingservice.domain.OrderingService.*(..))")
