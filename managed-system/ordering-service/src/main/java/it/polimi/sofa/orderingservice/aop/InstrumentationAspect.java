package it.polimi.sofa.orderingservice.aop;

import it.polimi.sofa.orderingservice.exceptions.ForcedException;
...
public class InstrumentationAspect {
    ...
    @Pointcut("execution(public * it.polimi.sofa.orderingservice.domain.OrderingService.*(..))")
    public void orderingServiceMethods() {}

    @Pointcut("execution(public void it.polimi.sofa.orderingservice.domain.OrderingService.*(..))")
