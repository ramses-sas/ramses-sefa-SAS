package it.polimi.sofa.restaurantservice.aop;

import it.polimi.sofa.restaurantservice.exceptions.ForcedException;
...
public class InstrumentationAspect {
    ...
    @Pointcut("execution(public * it.polimi.sofa.restaurantservice.domain.RestaurantService.*(..))")
    public void restaurantServiceMethods() {}

    @Pointcut("execution(public void it.polimi.sofa.restaurantservice.domain.RestaurantService.*(..))")
