package it.polimi.sofa.webservice.aoplog;
...
public class WebServiceLoggingAspect {
    ...
    @Pointcut("execution(public * it.polimi.sofa.webservice.domain.admin.AdminWebService.*(..))")
    public void webServiceMethods() {}

    @Pointcut("execution(public void it.polimi.sofa.webservice.domain.admin.AdminWebService.*(..))")
