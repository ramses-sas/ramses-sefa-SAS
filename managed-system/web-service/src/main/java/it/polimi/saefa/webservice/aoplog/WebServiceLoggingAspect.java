package it.polimi.saefa.webservice.aoplog;
...
public class WebServiceLoggingAspect {
    ...
    @Pointcut("execution(public * it.polimi.saefa.webservice.domain.admin.AdminWebService.*(..))")
    public void webServiceMethods() {}

    @Pointcut("execution(public void it.polimi.saefa.webservice.domain.admin.AdminWebService.*(..))")
