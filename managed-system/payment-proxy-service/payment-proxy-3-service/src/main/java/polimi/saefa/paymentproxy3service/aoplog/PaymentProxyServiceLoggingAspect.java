package polimi.saefa.paymentproxy3service.aoplog;
...
public class PaymentProxyServiceLoggingAspect {
    ...
    @Pointcut("execution(public * polimi.saefa.paymentproxy3service.domain.PaymentProxyService.*(..))")
    public void paymentProxyServiceMethods() {}

    @Pointcut("execution(public void polimi.saefa.paymentproxy3service.domain.PaymentProxyService.*(..))")
