package polimi.saefa.deliveryproxy2service.aoplog;
...
public class DeliveryProxyServiceLoggingAspect {
    ...
    @Pointcut("execution(public * polimi.saefa.deliveryproxy2service.domain.DeliveryProxyService.*(..))")
    public void deliveryProxyServiceMethods() {}

    @Pointcut("execution(public void polimi.saefa.deliveryproxy2service.domain.DeliveryProxyService.*(..))")
