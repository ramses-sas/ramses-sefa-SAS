package polimi.saefa.deliveryproxy3service.aoplog;
...
public class DeliveryProxyServiceLoggingAspect {
    ...
    @Pointcut("execution(public * polimi.saefa.deliveryproxy3service.domain.DeliveryProxyService.*(..))")
    public void deliveryProxyServiceMethods() {}

    @Pointcut("execution(public void polimi.saefa.deliveryproxy3service.domain.DeliveryProxyService.*(..))")
