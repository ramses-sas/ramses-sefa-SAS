package it.polimi.saefa.paymentproxy2service.aoplog;
...
public class PaymentProxyServiceLoggingAspect {
    ...
    @Pointcut("execution(public * it.polimi.saefa.paymentproxy2service.domain.PaymentProxyService.*(..))")
    public void paymentProxyServiceMethods() {}

    @Pointcut("execution(public void it.polimi.saefa.paymentproxy2service.domain.PaymentProxyService.*(..))")
