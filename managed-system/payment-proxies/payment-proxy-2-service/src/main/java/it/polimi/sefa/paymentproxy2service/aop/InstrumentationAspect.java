package it.polimi.sefa.paymentproxy2service.aop;

import it.polimi.sefa.paymentproxy2service.exception.ForcedException;
...
public class InstrumentationAspect {
    ...
    @Pointcut("execution(public * it.polimi.sefa.paymentproxy2service.domain.PaymentProxyService.*(..))")
    public void paymentProxyServiceMethods() {}

    @Pointcut("execution(public void it.polimi.sefa.paymentproxy2service.domain.PaymentProxyService.*(..))")
