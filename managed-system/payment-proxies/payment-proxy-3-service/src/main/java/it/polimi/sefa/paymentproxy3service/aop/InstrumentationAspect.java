package it.polimi.sefa.paymentproxy3service.aop;

import it.polimi.sefa.paymentproxy3service.exception.ForcedException;
...
public class InstrumentationAspect {
    ...
    @Pointcut("execution(public * it.polimi.sefa.paymentproxy3service.domain.PaymentProxyService.*(..))")
    public void paymentProxyServiceMethods() {}

    @Pointcut("execution(public void it.polimi.sefa.paymentproxy3service.domain.PaymentProxyService.*(..))")
