package it.polimi.saefa.paymentproxy3service.aop;

import it.polimi.saefa.paymentproxy3service.exception.ForcedException;
...
public class InstrumentationAspect {
    ...
    @Pointcut("execution(public * it.polimi.saefa.paymentproxy3service.domain.PaymentProxyService.*(..))")
    public void paymentProxyServiceMethods() {}

    @Pointcut("execution(public void it.polimi.saefa.paymentproxy3service.domain.PaymentProxyService.*(..))")
