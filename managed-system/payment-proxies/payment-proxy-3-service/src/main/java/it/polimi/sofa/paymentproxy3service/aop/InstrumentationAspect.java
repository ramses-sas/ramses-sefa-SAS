package it.polimi.sofa.paymentproxy3service.aop;

import it.polimi.sofa.paymentproxy3service.exception.ForcedException;
...
public class InstrumentationAspect {
    ...
    @Pointcut("execution(public * it.polimi.sofa.paymentproxy3service.domain.PaymentProxyService.*(..))")
    public void paymentProxyServiceMethods() {}

    @Pointcut("execution(public void it.polimi.sofa.paymentproxy3service.domain.PaymentProxyService.*(..))")
