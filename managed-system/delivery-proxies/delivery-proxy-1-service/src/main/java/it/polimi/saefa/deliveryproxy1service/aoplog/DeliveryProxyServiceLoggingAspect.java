package it.polimi.saefa.deliveryproxy1service.aoplog;
...
public class DeliveryProxyServiceLoggingAspect {
    ...
    @Pointcut("execution(public * it.polimi.saefa.deliveryproxy1service.domain.DeliveryProxyService.*(..))")
    public void deliveryProxy1ServiceMethods() {}

    @Pointcut("execution(public void it.polimi.saefa.deliveryproxy1service.domain.DeliveryProxyService.*(..))")
