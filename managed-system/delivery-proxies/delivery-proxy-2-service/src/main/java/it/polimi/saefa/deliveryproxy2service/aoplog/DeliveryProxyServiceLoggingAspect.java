package it.polimi.saefa.deliveryproxy2service.aoplog;
...
public class DeliveryProxyServiceLoggingAspect {
    ...
    @Pointcut("execution(public * it.polimi.saefa.deliveryproxy2service.domain.DeliveryProxyService.*(..))")
    public void deliveryProxyServiceMethods() {}

    @Pointcut("execution(public void it.polimi.saefa.deliveryproxy2service.domain.DeliveryProxyService.*(..))")
