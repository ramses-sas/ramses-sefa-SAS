package it.polimi.sofa.deliveryproxy3service.aop;

import it.polimi.sofa.deliveryproxy3service.exception.ForcedException;
...
public class InstrumentationAspect {
    ...
    @Pointcut("execution(public * it.polimi.sofa.deliveryproxy3service.domain.DeliveryProxyService.*(..))")
    public void deliveryProxyServiceMethods() {}

    @Pointcut("execution(public void it.polimi.sofa.deliveryproxy3service.domain.DeliveryProxyService.*(..))")
