package it.polimi.sefa.deliveryproxy3service.aop;

import it.polimi.sefa.deliveryproxy3service.exception.ForcedException;
...
public class InstrumentationAspect {
    ...
    @Pointcut("execution(public * it.polimi.sefa.deliveryproxy3service.domain.DeliveryProxyService.*(..))")
    public void deliveryProxyServiceMethods() {}

    @Pointcut("execution(public void it.polimi.sefa.deliveryproxy3service.domain.DeliveryProxyService.*(..))")
