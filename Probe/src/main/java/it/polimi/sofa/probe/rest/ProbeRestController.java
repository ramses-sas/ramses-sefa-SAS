package it.polimi.sofa.probe.rest;

import it.polimi.sofa.probe.configuration.ServiceConfiguration;
import it.polimi.sofa.probe.domain.InstanceStatus;
import it.polimi.sofa.probe.domain.ProbeService;
import it.polimi.sofa.probe.domain.ServiceInfo;
