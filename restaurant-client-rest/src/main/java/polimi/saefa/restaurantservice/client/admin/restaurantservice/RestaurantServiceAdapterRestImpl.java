...
@Service
public class RestaurantServiceAdapterRestImpl implements RestaurantServiceAdapter {

    private Logger logger = Logger.getLogger(RestaurantServiceAdapterRestImpl.class.toString());

    @Value("${polimi.saefa.restaurantservice.admin.uri}")
    private String restaurantServiceUri;

    private WebClient webClient;

    public RestaurantServiceAdapterRestImpl(WebClient.Builder webClientBuilder) {
