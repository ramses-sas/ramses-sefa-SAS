package polimi.saefa.deliveryproxyservice1.aoplog;
...
public class DeliveryProxyServiceLoggingAspect {
    ...
    @Pointcut("execution(public * polimi.saefa.deliveryproxyservice1.domain.DeliveryProxyService.*(..))")
    public void deliveryProxyServiceMethods() {}

    @Pointcut("execution(public void polimi.saefa.deliveryproxyservice1.domain.DeliveryProxyService.*(..))")
