package polimi.saefa.paymentproxyservice2.aoplog;
...
public class PaymentProxyServiceLoggingAspect {
    ...
    @Pointcut("execution(public * polimi.saefa.paymentproxyservice2.domain.PaymentProxyService.*(..))")
    public void paymentProxyServiceMethods() {}

    @Pointcut("execution(public void polimi.saefa.paymentproxyservice2.domain.PaymentProxyService.*(..))")
