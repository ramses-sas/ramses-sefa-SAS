package polimi.saefa.paymentproxyservice1.aoplog;
...
public class PaymentProxyServiceLoggingAspect {
    ...
    @Pointcut("execution(public * polimi.saefa.paymentproxyservice1.domain.PaymentProxyService.*(..))")
    public void paymentProxyServiceMethods() {}

    @Pointcut("execution(public void polimi.saefa.paymentproxyservice1.domain.PaymentProxyService.*(..))")
